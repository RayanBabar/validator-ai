...
class ValidationState(TypedDict):
    ...
    dimension_quality: Optional[
        Dict[str, float]
    ]  # Per-dimension quality scores for granular viability adjustments
    ...
    extracted_geography: Optional[
        str
    ]  # e.g., "USA - Chicago", "Pakistan", "EU", "Global"
    extracted_regulatory_context: Optional[str]  # e.g., "GDPR", "FDA", "None specified"
    context_specificity_score: Optional[
        float
    ...
    # Strategic Directive (the "Truth" document for module consistency)
    strategic_directive: Optional[Any]  # StrategicDirective Pydantic model
